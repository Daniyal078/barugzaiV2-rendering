...
export default function HeroSlider({ banners }: HeroSliderProps) {
    ...
    return (
        <section className="relative h-[50vh] md:h-screen w-full overflow-hidden bg-black text-white">
            ...
            <div className="absolute bottom-25 left-1/2 -translate-x-1/2 flex gap-4 z-20">
                {banners.map((_, index) => (
                    <button
                        key={index}
                        ...
                        className="group"
                    >
                        <div className="md:w-30 w-10 h-0.75 bg-white/30 overflow-hidden rounded-full">
                            <motion.div
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-white animate-bounce text-xl">
                ˅
            </div>
